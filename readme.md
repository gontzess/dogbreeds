Create a Node application that makes a call to an external API for an object containing dog breeds and sub breeds. Url is [https://dog.ceo/api/breeds/list/all](https://dog.ceo/api/breeds/list/all) .
